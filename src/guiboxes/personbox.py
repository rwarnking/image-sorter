...
class ModifyPersonBox(BaseBox):
    def __init__(self, header, db, person=""):
        ...
        ent_p_name = Entry(self.root, textvariable=self.sv_p_name, width=50, validate="key", validatecommand=vcmd)
        ent_p_name.grid(
        ...
        Hovertip(self.btn_add_psn, TooltipDict["btn_add_psn" if person == "" else "btn_update_psn"])
